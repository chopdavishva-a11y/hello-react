...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}>
            ...
            <button className="btn btn-primary mx-1" onClick={handleLoClick}>Convert to lowecasw</button>
      ...
      <button className="btn btn-primary mx-1" onClick={handleExtraSpaces}>Remove Extra Spaces</button>
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}>
            ...
            <h2>Preview</h2>
            <p style={{ color: color }}>{text.length>0?text:"Enter something in the textbox above to preview it here"}</p> {/* Preview text color */}
        </div>
        </>
    )
}
